...
telephone int unique not null,library id int unique not null
);
...
create table pulishing_company(name varchar(255) not null,id primary key not null);
...
int not null unique,date_of_return varchar not null
);
crate table r
);
